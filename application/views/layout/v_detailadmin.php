...
<section>
    <div class="container">
        ...
        <div class="col-lg-auto mx-3 px-3 py-3">
            ...
            <br>
                <center><div class="col-md-10 col-sm-4 mx-auto">
                    ...
                    <h4 class="fw-bolder text-warning"> <?= "( Patokan : ".$detailadmin->patokan. ")" ?></h4>
        ...
        <script>
            ...
            .bindPopup("<h5><b> Daerah Jalan<br><br><?= $detailadmin->patokan?></b><br><br> Latitude : <?= $detailadmin->pusat_lat?><br><br> Longitude : <?= $detailadmin->pusat_long?><br><br></h5>");
