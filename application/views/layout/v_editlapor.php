                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-4">
                    <select class="form-control" name="status_lapor">
                      ...
                      <option value="0" <?= $detaillapor->status_lapor == 0 ? 'selected' : ''?>>DITOLAK</option>
                      <option value="1" <?= $detaillapor->status_lapor == 1 ? 'selected' : ''?>>DITERIMA</option>
                      <option value="2" <?= $detaillapor->status_lapor == 2 ? 'selected' : ''?>>DIPROSES</option>
                    </select>
                  </div>
                </div>
              </div>
