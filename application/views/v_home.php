            ...
            <div class="card mx-3 px-4 center grid-margin stretch-card">
                <div class="card-body"> 
                    ...
                    <script>
                        ...
                        var dataFive = {
                            label: "Tahun 2024 ",
                            borderColor: ['rgba(360, 99, 132, 1)'],
                            backgroundColor: 'rgba(360, 99, 132, 0.6)',
                ...
                <div class="row">
                    ...
                    <script>
                        ...
                        <?php foreach ($black as $value) {?>
                            ...
                            .bindPopup("<h5><b> Daerah Jalan <?= $value->idblack?> <br><br><?= $value->daerah_jalan?></b><br><br> Patokan Jalan : <?= $value->patokan?><br>Kecamatan : <?= $value->kecamatan?><br> Tahun : <?= $value->tahun?><br> Jumlah Kasus : <?= $value->total_idkasus?><br><br> Status Jalan : <?php
                                    if($value->status == '0' and $value->aek > $value->bca){
