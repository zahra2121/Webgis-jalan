                ...
                <div class="row">
                    ...
                    <script>
                        ...
                        <?php foreach ($peta as $key => $value) {?>
                            ...
                            .bindPopup("<h5><b> <?=$value->tanggal?> <br><br><?= $value->daerah_jalan?></b><br><br> Patokan: <?= $value->daerah_jalan. "<br><br> Riwayat kasus: " .$value->total_idkasus?><br><br> Status Jalan: <?php
                                    if($value->status == '0' and $value->aek > $value->bca){
