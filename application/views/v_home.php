                ...
                <div class="row">
                    ...
                    <script>
                        ...
                        <?php foreach ($black as $value) {?>
                            ...
                            .bindPopup("<h5><b> <?=$value->tanggal?> <br><br><?= $value->daerah_jalan?></b><br><br> Patokan :<br> <?= $value->patok_black?><br> Riwayat kasus : <?= $value->total_idkasus?><br><br> Status Jalan : <?php
                                    if($value->status == '0' and $value->aek > $value->bca){
