            ...
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <p class="card-description"><b>Selamat Datang, Anda Login sebagai <?php echo ucfirst($this->session->userdata('nama')); ?></b>
                   <br> Anda dapat menambah data laporan kecelakaan lalu lintas terbaru di Kabupaten Bantul</p>
