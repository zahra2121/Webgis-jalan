...
<html lang="en">
    <head>
        ...
        <script>
            ...
            {
                document.getElementById('current').innerHTML="Lokasi Latitude saat ini: <label class='badge bg-warning text-dark font-size=10px'>"+p.coords.latitude+"</label><br>Longitude saat ini: <label class='badge bg-warning text-dark'>"+p.coords.longitude+"</label>";
