...
<html lang="en">
    <head>
        ...
        <script>
            ...
            {
                document.getElementById('current').innerHTML="Lokasi Latitude saat ini: <label class='badge badge-primary col-xs-4'>"+p.coords.latitude+"</label><br>Longitude saat ini: <label class='badge badge-primary'>"+p.coords.longitude+"</label>";
