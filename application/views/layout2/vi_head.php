...
<html lang="en">
    <head>
        ...
        <script>
            ...
            {
                document.getElementById('current').innerHTML="Lokasi Latitude saat ini: <label class='badge bg-warning'>"+p.coords.latitude+"</label><br>Longitude saat ini: <label class='badge bg-warning'"+p.coords.longitude+"</label>";
