...
<html lang="en">
    <head>
        ...
        <script>
            ...
            {
                document.getElementById('current').innerHTML="Titik Latitude saat ini: <span class='badge badge-primary col-xs-4'>"+p.coords.latitude+"</span><br>Longitude saat ini: <span class='badge badge-primary'>"+p.coords.longitude+"</span>";
