          ...
          <div class="row w-100 mx-0">
            <div class="col-lg-4 mx-auto">
              ...
              ?>
                ...
                <center>
                    <h3 class="font-weight-light"><b>Lupa Password</b></h3>
                ...
                <form class="pt-3">
                  <div class="form-group">
                    <p>Masukkan Email:</p>
                    <input type="email" class="form-control form-control-lg" placeholder="Email" name="email" value="<?php echo set_value('email'); ?>" />
                  ...
                  <div class="text-center mt-4 font-weight-light">
                    Kembali Login? <a href="<?= base_url() ?>index.php/login" class="text-primary">Back</a>
                  </div>
                </form>
